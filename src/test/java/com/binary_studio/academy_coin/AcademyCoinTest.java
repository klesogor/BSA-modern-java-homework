...
class AcademyCoinTest {
    ...
    void AcademyCoin_ProfitWithTwoSpikes_SpikeDiffSumReturned() {
        assertEquals(
                7,
                AcademyCoin.maxProfit(Arrays.stream(new int[]{7, 1, 5, 3, 6, 4}).boxed()),
    ...
    void AcademyCoin_ProfitWithNoDecrease_FirstAndLastDiffReturned(){
        assertEquals(
                4,
                AcademyCoin.maxProfit(Arrays.stream(new int[]{1,2,3,4,5}).boxed()),
    ...
    void AcademyCoin_NoProfitAtAll_ZeroReturnd() {
        assertEquals(
                0,
                AcademyCoin.maxProfit(Arrays.stream(new int[]{7,6,4,3,1}).boxed()),
